...
export default function DescriptionBox({ gameData }) {
  ...
  return (
    <div>
      <div
        className={`description-box card-global`}
        style={{ padding: "24px" }}
      >
        <h1 className="text-gradient"> Summary </h1>
        <p>{summary}</p>
        <h1 className="text-gradient"> Genres </h1>
        ...
        {storyline && <h1 className="text-gradient"> Storyline </h1>}
        {storyline && <p>{storyline}</p>}
        <h1 className="text-gradient"> Platforms </h1>
        <div className="platform-container">{platforms}</div>
        <h1 className="text-gradient"> Age Rating </h1>
        {esrbDetails && (
          <>
            <img
